...
sealed interface CreateWarrantyEvent {
    ...
    data class SerialNumberChanged(val value: String) : CreateWarrantyEvent
    ...
    data object PhotoRemoved : CreateWarrantyEvent
    data object SaveClicked : CreateWarrantyEvent
}